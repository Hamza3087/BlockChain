...
curl -X POST -H "Content-Type: application/json" -d '{
    ...
    "params": [
        "BHcCroWFZYHQatgt6FtfkruLdPP9BvcnQ5iiJvs7DzjuPHAzpd6SUfqTd8KP2yYxeA4sNpiZioBLDCWtcFuJA95",
        {
            "encoding": "json",
...
echo "View on Solana Explorer: https://explorer.solana.com/tx/BHcCroWFZYHQatgt6FtfkruLdPP9BvcnQ5iiJvs7DzjuPHAzpd6SUfqTd8KP2yYxeA4sNpiZioBLDCWtcFuJA95?cluster=devnet"
