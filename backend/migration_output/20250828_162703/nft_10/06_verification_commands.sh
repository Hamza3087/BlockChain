...
curl -X POST -H "Content-Type: application/json" -d '{
    ...
    "params": [
        "4fAYkCvVPRejonTEszNcDNG2UcDLQLr7S2EqxEPsStbPXomDQVqPAa8LjteLCSHZwrz6KtPqsRpFZs9yr8RGuQiz",
        {
            "encoding": "json",
...
echo "View on Solana Explorer: https://explorer.solana.com/tx/4fAYkCvVPRejonTEszNcDNG2UcDLQLr7S2EqxEPsStbPXomDQVqPAa8LjteLCSHZwrz6KtPqsRpFZs9yr8RGuQiz?cluster=devnet"
