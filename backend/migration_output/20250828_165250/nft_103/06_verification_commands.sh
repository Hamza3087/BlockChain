...
curl -X POST -H "Content-Type: application/json" -d '{
    ...
    "params": [
        "3GYx7znWtrf8iQRJA4W9Qx76FZtmfjtcDriWcxbVVUBZuWXp4RzzUBcngQdXMWd8gcGCxsCr7aFsRWmEamYaipvE",
        {
            "encoding": "json",
...
echo "View on Solana Explorer: https://explorer.solana.com/tx/3GYx7znWtrf8iQRJA4W9Qx76FZtmfjtcDriWcxbVVUBZuWXp4RzzUBcngQdXMWd8gcGCxsCr7aFsRWmEamYaipvE?cluster=devnet"
