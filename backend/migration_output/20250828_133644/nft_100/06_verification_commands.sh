...
curl -X POST -H "Content-Type: application/json" -d '{
    ...
    "params": [
        "2vrSwgrTQgn5jT29PdLZRtoSzQXWt7AFjrPhpdxr4MKSWbFAvregvdZN2chVgWxy2eLY6KZqmFWqK83UMUjCzFx7",
        {
            "encoding": "json",
...
echo "View on Solana Explorer: https://explorer.solana.com/tx/2vrSwgrTQgn5jT29PdLZRtoSzQXWt7AFjrPhpdxr4MKSWbFAvregvdZN2chVgWxy2eLY6KZqmFWqK83UMUjCzFx7?cluster=devnet"
