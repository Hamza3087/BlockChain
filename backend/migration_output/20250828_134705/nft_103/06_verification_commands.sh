...
curl -X POST -H "Content-Type: application/json" -d '{
    ...
    "params": [
        "369ZF8BnCzrnVZDLbf2Nvbzh1KT3jqaiHESsXh2r2BYiPsvBtErDjjfDJawxRGHTcQVahtSq5h91axQJ4EkAtAou",
        {
            "encoding": "json",
...
echo "View on Solana Explorer: https://explorer.solana.com/tx/369ZF8BnCzrnVZDLbf2Nvbzh1KT3jqaiHESsXh2r2BYiPsvBtErDjjfDJawxRGHTcQVahtSq5h91axQJ4EkAtAou?cluster=devnet"
