...
curl -X POST -H "Content-Type: application/json" -d '{
    ...
    "params": [
        "538gywcEYWfZwruVvD95XQLS21QXALTH2S7EYrqeMUVX1vSoCNwUAuRrJQ1EacD4kb8tBHwAocLB5u5okxTkQHTR",
        {
            "encoding": "json",
...
echo "View on Solana Explorer: https://explorer.solana.com/tx/538gywcEYWfZwruVvD95XQLS21QXALTH2S7EYrqeMUVX1vSoCNwUAuRrJQ1EacD4kb8tBHwAocLB5u5okxTkQHTR?cluster=devnet"
